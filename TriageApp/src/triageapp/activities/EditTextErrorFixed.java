 ...
 * disappearing on pressing delete in an empty EditText in 
 * Android versions 4.2 and 4.2.1.
 * @author Oleg Vaskevich (http://stackoverflow.com/a/14175640/832776)
 */
public class EditTextErrorFixed extends EditText {
    ...
    /**
     * Sets the error message and icon to null on text changed event.
     */
    @Override
